...
Began with four sets of SFTConfig() parameter configurations. Using the same prompt and generation parameters,
their generations are compared both dynamically and through metrics such as loss or similarity embeddings to determine
